...
./node_modules/.bin/gulp release-win64 --out=../build/windows/x64/$BRANCH/$FILE64 || exit 1;
./node_modules/.bin/gulp release-win32 --out=../build/windows/x32/$BRANCH/$FILE32 || exit 1;
